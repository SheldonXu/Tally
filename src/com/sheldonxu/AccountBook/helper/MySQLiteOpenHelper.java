...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    private final static String DB_NAME = "db_saved.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table if not exists tb_saved(_id integer primary key autoincrement , accdate ,accmoney,acctype,acctypename)");
    }
